              ...
              <div className="nav__dropdown" ref={dropRef}>
                ...
                {dropOpen && (
                  <div className="nav__drop">
                    ...
                    <div className="nav__drop-divider" />
                    <button type="button" onClick={handleLogout} className="nav__drop-item nav__drop-item--logout">
                      Sign Out
                    </button>
                  </div>
                )}
        ...
        {!authLoading && (
          user ? (
            <div style={{ marginTop: "1.4rem", display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <button type="button" onClick={handleLogout} className="nav__logout" style={{ fontSize: ".9rem" }}>Logout</button>
            </div>
          ) : (
