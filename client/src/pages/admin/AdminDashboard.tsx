...
export default function AdminDashboard() {
  const { data, loading } = useApiData(() =>
    ...
    ]).then(([artworks, collections, process, testimonials, users, orders]) => ({
  ...
  const { artworks, collections, process, testimonials, users, orders } = data;
