/* =========================================================================
   Commission page — full inquiry flow
   ========================================================================= */
  ...
  return (
    <main>
      <header className="cm-hero">
        <div className="wrap">
          <Reveal><Eyebrow idx="">Commission</Eyebrow></Reveal>
      ...
      <section className="section--tight section">
        <div className="wrap cm-grid">
          <div className="cm-left">
            <Reveal><Eyebrow idx="">How it works</Eyebrow></Reveal>
            ...
            <Reveal>
              <Eyebrow idx="" style={{ marginTop: "1rem" }}>Guide pricing</Eyebrow>
            ...
            <div className="cm-form-card">
              {!sent ? (
                ...
                <div className="cm-thanks">
                  ...
                  <button className="link-u" onClick={() => { setSent(false); setForm({ name: "", email: "", type: "Portrait", size: "Medium", budget: "", message: "" }); }}>Send another <span className="arr">→</span></button>
                </div>
              )}
            </div>
          </Reveal>
...
ReactDOM.createRoot(document.getElementById("root")).render(<CommissionApp />);
