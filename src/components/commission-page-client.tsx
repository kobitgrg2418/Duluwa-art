...
export function CommissionPageClient({ pricing }: { pricing: CommissionTier[] }) {
  useRevealEngine();
            ...
            <div className="cm-left">
              ...
              <Reveal>
                ...
                <div className="cm-pricing">
                  {pricing.map((p) => (
                    <div className="cm-price" key={p.label}>
                      <h4>{p.label}</h4>
                      <span className="amt">from {p.price}</span>
                ...
                {!sent ? (
                  <form className="cm-form" onSubmit={submit}>
                    ...
                    <label className="field"><span className="field__label">Budget (optional)</span>
                      <input value={form.budget} onChange={set("budget")} placeholder="e.g. Rs 50,000" /></label>
